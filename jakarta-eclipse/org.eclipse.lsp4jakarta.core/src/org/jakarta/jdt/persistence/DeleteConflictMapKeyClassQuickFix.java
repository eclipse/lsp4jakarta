...
/**
 * 
 * Quick fix for removing @MapKeyClass when @MapKey is used for the same field or property
 * 
 * @author Jianing Xu
 *
 */
public class DeleteConflictMapKeyClassQuickFix extends RemoveAnnotationConflictQuickFix {
	
	public DeleteConflictMapKeyClassQuickFix() {
		super("jakarta.persistence.annotation.MapKeyClass");
	}
