...
import org.eclipse.lsp4jakarta.ls.commons.ListLineTracker.DelimiterInfo;
...
//		}
        ...
        if (offset > endLineOffset)
            throw new BadLocationException("The character value, {" + character + "} of the line {" + line + "}, is out of bounds. Line length is {" + lineLength + "}");
        return offset;
