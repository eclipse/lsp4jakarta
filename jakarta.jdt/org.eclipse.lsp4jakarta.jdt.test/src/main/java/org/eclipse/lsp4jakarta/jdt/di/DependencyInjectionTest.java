...
public class DependencyInjectionTest extends BaseJakartaTest {
    ...
    public void DependencyInjectionDiagnostics() throws Exception {
         ...
         * 
         */
        Diagnostic d1 = d(25, 27, 35, "The annotation @Inject must not define a final field.",
                DiagnosticSeverity.Error, "jakarta-di", "RemoveInjectOrFinal");
        d1.setData(IType.FIELD);

        Diagnostic d2 = d(41, 25, 39, "The annotation @Inject must not define an abstract method.",
                DiagnosticSeverity.Error, "jakarta-di", "RemoveInjectOrAbstract");
        d2.setData(IType.METHOD);
        
        Diagnostic d3 = d(34, 22, 33, "The annotation @Inject must not define a final method.",
                DiagnosticSeverity.Error, "jakarta-di", "RemoveInjectOrFinal");
        d3.setData(IType.METHOD);
 
        Diagnostic d4 = d(51, 23, 36, "The annotation @Inject must not define a generic method.",
                DiagnosticSeverity.Error, "jakarta-di", "RemoveInjectForGeneric");
        d4.setData(IType.METHOD);
        
        Diagnostic d5 = d(45, 23, 35, "The annotation @Inject must not define a static method.",
        ...
        TextEdit te = te(24, 4, 25, 4,
                "");
        CodeAction ca = ca(uri, "Remove @Inject", d1, te);
        TextEdit te1 = te(25, 11, 25, 17,
                "");
